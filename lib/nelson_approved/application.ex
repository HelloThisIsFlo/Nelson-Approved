defmodule NelsonApproved.Application do
  use Application
  ...
  def start(_type, _args) do
    ...
    children = [
      ...
      supervisor(NelsonApproved.Repo, []),
    ...
    opts = [strategy: :one_for_one, name: NelsonApproved.Supervisor]
  ...
  def config_change(changed, _new, removed) do
    NelsonApproved.Endpoint.config_change(changed, removed)
    :ok
  end
end
